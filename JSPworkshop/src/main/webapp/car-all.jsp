<%@ page import="services.Impl.CarServiceImpl" %>
...
<div class="container-fluid">
    ...
    <div class='row mb-4 d-flex justify-content-around'>
        ...
        <%for (CarViewModel carViewModel : ((List<CarViewModel>) request.getAttribute("viewModel"))) { %>
        <div class="col-md-4 d-flex flex-column bg-text mb-3">
            <h2>Owner: <%= carViewModel.getUserUsername()%></h2>
            <h2>Brand: <%=carViewModel.getBrand()%></h2>
            <h4>Model: <%=carViewModel.getModel()%></h4>
            <h4>Year: <%=carViewModel.getYear()%></h4>
            <h4>Engine: <%=carViewModel.getEngine()%></h4>
        </div>
        <% } %>
</body>
</html>